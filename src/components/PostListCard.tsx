...
// CHANGELOG
//   2026-06-19
//     - [근본수정] 커버 이미지 박스 비율: 와이드(고정 height 130/180 ≈ 1.67) → 정사각(1:1).
//         원인: 고정 height는 프레이밍 의도가 아니라 옛 '본문 잠식' 버그(6/7) 회피용
//             부산물. 세로사진이 와이드 박스에 cover 되며 가로 한 줄만 남아 과확대.
//         조치: index.css '.post-card__img' 를 height 고정 → aspect-ratio:1/1 로 변경
//             (이 파일은 박스를 .post-card__img 클래스로만 지정하므로 TSX 구조 변경 없음).
//             실측 ar 0.56~1.78 분포에서 최악 크롭 최소화 비율이 정사각이라 채택.
//             cover/ 커버 focal-point(object-position) 기능은 유지.
//   2026-06-11
