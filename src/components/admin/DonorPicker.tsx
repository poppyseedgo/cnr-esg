...
//   → 선택을 실제 포인터이벤트(pointerup)에서 처리하고, 이동거리로 '탭 vs 스크롤'을 구분.
//     pointerup 은 손을 떼는 즉시(키보드 닫힘과 무관) 발생하므로 첫 탭에 바로 선택된다.
...
//   2026-06-08  [요청] "직접 입력(외부 기증자)" 옵션 제거 — 임직원 검색 전용
// ============================================================================
...
export interface DonorValue {
  id: string | null;        // 임직원 profiles.id (레거시 데이터 호환 위해 null 허용)
  name: string;
  dept: string | null;
